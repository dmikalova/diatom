...
- **Rejecting creates work immediately.** The rejected hunk's comments, with its lines as context, are added to the workstream's pending revision. There is no separate "submit review" step.

...
- **`diatom workspace` opens a zellij layout**, which you can detach from and reattach to, with four panes:
  ...
  Review and intake follow a single focused goal. From the status pane, the human switches focus, opens another repo from a picker over the search roots, and parks or resumes goals.
